 ...
 */
public class MappingBridgePlugin extends Plugin {
  
	/** The shared instance */
	private static MappingBridgePlugin __plugin;
	
	
	/**
	 * Constructor
	 */
	public MappingBridgePlugin() {
	  // Nothing needed
	}
   ...
   */
  public static MappingBridgePlugin getDefault() {
    return __plugin;
  }
