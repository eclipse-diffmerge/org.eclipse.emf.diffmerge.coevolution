...
public class BridgetracesAdapterFactory extends AdapterFactoryImpl {
   ...
   * @generated
   */
  protected BridgetracesSwitch<Adapter> modelSwitch =
    new BridgetracesSwitch<Adapter>() {
      @Override
      public Adapter caseTrace(Trace object) {
        return createTraceAdapter();
      }
      @Override
      public Adapter caseTraceEntry(Map.Entry<String, String> object) {
        return createTraceEntryAdapter();
      }
      @Override
      public Adapter caseITrace(ISymbolBasedBridgeTrace.Editable object) {
        return createITraceAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.emf.diffmerge.bridge.traces.gen.bridgetraces.Trace <em>Trace</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link java.util.Map.Entry <em>Trace Entry</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.emf.diffmerge.bridge.api.incremental.ISymbolBasedBridgeTrace.Editable <em>ITrace</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
