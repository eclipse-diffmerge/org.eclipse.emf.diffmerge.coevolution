...
public class install_buckminster extends org.eclipse.egf.portfolio.eclipse.build.buckminster.buildxml {
	protected static String nl;

	public static synchronized install_buckminster create(String lineSeparator) {
		nl = lineSeparator;
		install_buckminster result = new install_buckminster();
		nl = null;
		return result;
	}
